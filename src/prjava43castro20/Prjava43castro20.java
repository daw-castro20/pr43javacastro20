package prjava43castro20; 
import java.awt.*;        // using AWT containers and components 
import java.awt.event.*;  // using AWT events and listener interfaces 
import java.net.*;
// An AWT GUI program inherits the top-level container java.awt.Frame 
public class Prjava43castro20 extends Frame 
   ...
   public Prjava43castro20 () { 
      ...
      setTitle("Nova finestra prjava43castro20");  // "this" Frame sets title 
   ...
   public static void main(String[] args) { 
      new Prjava43castro20();  // Let the construct do the job 
   } 
